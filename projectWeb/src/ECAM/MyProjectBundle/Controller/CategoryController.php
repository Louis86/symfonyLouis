...
class CategoryController extends Controller
{
    ...
    {
        $category_repository =
            $this->getDoctrine()->getRepository('ECAMMyProjectBundle:Category');

        $categories = $category_repository->findAll();

        return $this->render(
            'ECAMMyProjectBundle:Category:list_category.html.twig',
            array(
    ...
    public function editAction(Request $request, Category $category)
    {
        ...
        return $this->render(
            'ECAMMyProjectBundle:Category:new_category.html.twig',
            array(
